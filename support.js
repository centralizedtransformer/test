(function() {
    ...
    function customScript() {
        ...
        $(document).ready(function() {
            ...
            if (!$('#serp').length) {
                $('.icon-article-doc')
                    .after(`<img class="star-icon" src="https://centralizedtransformer.github.io/test/images/icons/academy.svg?ver=1.1" />`)
                    .remove()
            } else {
            ...
            $('.category').each(function() {
                ...
                element.prepend(
                    `<img class="category-icon" src="https://centralizedtransformer.github.io/test/images/icons/${obj.icon}.svg?ver=1.1" />`
                )
            ...
            <form class="subscribe__form" data-key="SUBSCRIBE_SECTION_KEY">
            <input type="hidden" name="campaing_id" value="103714">
        ...
        <div class="modal-overlay" id="popup-subscribe">
            <div class="modal-window">
                ...
                <p class="p-18">
                    Your support helps us build a stronger and convenient platform.<br>A lot of interesting features are coming soon!
                </p>
                <div class="title-3">
        ...
        <form class="subscribe-form" data-key="SUBSCRIBE_POPUP_KEY">
            <input type="hidden" name="campaing_id" value="107128">
            <input type="hidden" name="action" value="subscribe">
            <input class="subscribe-email subscribe-control" placeholder="Your email" type="text" name="email">
            <button class="subscribe-button subscribe-control btn-blue" type="submit">
                Subscribe
            </button>
        </form>
        ...
        <div class="modal-overlay" id="popup-thanks">
            <div class="modal-window">
                <div class="modal-window__close">×</div>
                <div class="title-3">
                    Be a part of Atomic Community!
                </div>
                <p class="p-18">
                    Learn more about Atomic and explore blockchain from A to Z
                </p>
                <div class="two-buttons-container">
                    <a href="https://atomicwallet.io/blog/academy" class="btn-large btn-blue">
                        <i class="sprite-book-outline"></i>
                        crypto guides
                    </a>
                    <a href="https://support.atomicwallet.io" class="btn-large btn-outline">
    ...
    <ul class="social-links">
            ...
            <li>
                <a href="https://twitter.com/atomicwallet" rel="nofollow" target="_blank">
                    <img data-src="/images/icons/tw.svg" alt="" class=" ls-is-cached lazyloaded" src="/images/icons/tw.svg">
                </a>
            </li>
        
            <li>
                <a href="https://www.facebook.com/atomicwallet" rel="nofollow" target="_blank">
                    <img data-src="/images/icons/fb.svg" alt="" class=" ls-is-cached lazyloaded" src="/images/icons/fb.svg">
                </a>
            </li>
        
            <li>
                <a href="https://t.me/AtomicWalletNews" rel="nofollow" target="_blank">
                    <img data-src="/images/icons/tg.svg" alt="" class=" ls-is-cached lazyloaded" src="/images/icons/tg.svg">
                </a>
            </li>
        
    </ul>
                <p class="p-18">
                    Join our communities to follow latest updates, giveaways and lot more!
                </p>
            </div>
        </div>
    
        <div class="modal-overlay" id="popup-social">
            <div class="modal-window">
                <div class="modal-window__close">×</div>
                <div class="title-3">
                    Feel free to join our social media to stay in touch with Atomic Wallet!
                </div>
    ...
    <ul class="social-links">
            ...
            <li>
                ...
                <p class="p-18">
                    These links were created just for you
                </p>
            </div>
        </div>
    
        <div class="modal-overlay" id="popup-video">
            <div class="modal-window">
...
`);
            ...
            //     document.querySelector('.rateAction--positive').querySelector('.rating-face').innerHTML = "<img src='https://atomicwallet.io/images/support/smile--yes.svg?ver=1.1'>";
            //     document.querySelector('.rateAction--negative').querySelector('.rating-face').innerHTML = "<img src='https://atomicwallet.io/images/support/smile--no.svg?ver=1.1'>";
            // }
            assetLoaded();
        })
    }
